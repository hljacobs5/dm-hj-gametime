...
function animate() {
  ...
  // console.log(firstSnake)
  firstSnake.trails.push(firstSnakeTrail)
  secondSnake.trails.push(secondSnakeTrail)
  // console.log(firstSnake.trail)

  firstSnake.trails.forEach(function (trail, i) {
    // console.log(trail.x)
    // console.log(trail.y)
  ...
  secondSnake.trails.forEach(function(trail, j) {
